...
class   BoardPanel extends JPanel {
    ...
    private static final int FRAME_WIDTH = 740, FRAME_HEIGHT = 552;  // must be multiples of 4
    private static final int BORDER_TOP = 40, BORDER_BOTTOM = 70, BORDER_LEFT = 40, BORDER_RIGHT = 40;
    private static final int PIP_WIDTH = 50, BAR_WIDTH = 80;
    private static final int CHECKER_RADIUS = 20, CHECKER_DEPTH = 8, LINE_WIDTH = 2;   // must be even
    ...
    BoardPanel(Board board, Players players) {
        ...
        try {
            boardImage = ImageIO.read(this.getClass().getResource("output-onlinepngtools.png"));
